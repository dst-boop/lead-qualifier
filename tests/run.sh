...
SUITES="score-test.js mobile-test.js isolation-test.js zi-ui-test.js automap-test.js recipe-test.js edgar-ui-test.js zi-mcp-ui-test.js upgrade-test.js hh-test.js v3-test.js"
FAILED=""
for s in $SUITES; do
  printf '%-20s ' "$s"
...
for s in zi-oauth-test.py edgar-test.py zi-mcp-test.py; do
  printf '%-20s ' "$s"
