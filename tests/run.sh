...
SUITES="score-test.js mobile-test.js isolation-test.js zi-ui-test.js automap-test.js recipe-test.js edgar-ui-test.js zi-mcp-ui-test.js opps-ui-test.js research-prompt-test.js scs-test.js pipeline-test.js lists-ui-test.js track-ui-test.js upgrade-test.js hh-test.js v3-test.js"
FAILED=""
for s in $SUITES; do
  printf '%-20s ' "$s"
...
for s in zi-oauth-test.py edgar-test.py zi-mcp-test.py prospecting-test.py opportunities-test.py lists-test.py senders-test.py team-test.py; do
  printf '%-20s ' "$s"
