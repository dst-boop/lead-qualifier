...
for s in zi-oauth-test.py edgar-test.py zi-mcp-test.py prospecting-test.py opportunities-test.py lists-test.py senders-test.py team-test.py signals-test.py signals-api-test.py harvest-test.py plan-assets-test.py cache-test.py wp-record-test.py signals-coverage-test.py google-consent-test.py accounts-test.py wp-credits-test.py free-sources-test.py free-debug-test.py edgar-roster-test.py credits-test.py; do
  printf '%-20s ' "$s"
